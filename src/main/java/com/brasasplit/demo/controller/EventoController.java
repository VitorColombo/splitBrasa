...
public class EventoController {
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "422", description = "Erro de validação dos campos de entrada", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
                                        "  \"nome\": \"Nome inválido\",\n" +
                                        "  \"data\": \"Formato de data inválida\",\n" +
                                        "  \"local\": \"Local inválido\"\n" +
                                        "}"))),
                        @ApiResponse(responseCode = "409", description = "Conflito de concorrência. O evento foi modificado por outra pessoa.", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
                                        "  \"erro\": \"Erro de concorrencia. Tente novamente.\",\n" +
                                        "  \"detalhe\": \"mensagem de erro interna do spring\"\n" +
                                        "}")))
        })
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "404", description = "Evento não encontrados pelo id", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
        ...
        public ResponseEntity<EventoResponseDTO> atualizarEvento(@PathVariable String id,
                        @RequestBody @Valid EventoRequestDTO dadosAtualizados) {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Compra adicionada com sucesso"),
                        @ApiResponse(responseCode = "404", description = "Evento não encontrado", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
                                        "  \"erro\": \"Evento não encontrado com id: xxxxxxxx\"\n" +
                                        "}"))),
                        @ApiResponse(responseCode = "409", description = "Conflito de concorrência. O evento foi modificado por outra pessoa.", content = @Content(schema = @Schema(type = "object", example = "{\n"
        ...
        public ResponseEntity<EventoResponseDTO> adicionarCompra(@PathVariable String id,
                        @RequestBody @Valid CompraRequestDTO request) {
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "404", description = "Evento ou compra não encontrados pelo id", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
        ...
        public ResponseEntity<EventoResponseDTO> removerCompra(@PathVariable String eventoId,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Atualizacao aceita, retorna o novo estado da entidade"),
                        @ApiResponse(responseCode = "404", description = "Evento/compra não encontrados pelo id", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
                                        "  \"erro\": \"Evento/compra não encontrado com id: xxxxxxxx\",\n" +
                                        "}"))),
                        @ApiResponse(responseCode = "409", description = "Conflito de concorrência. O evento foi modificado por outra pessoa.", content = @Content(schema = @Schema(type = "object", example = "{\n"
        ...
        public ResponseEntity<EventoResponseDTO> atualizarCompra(@PathVariable String eventoId,
                        @PathVariable String compraId, @RequestBody @Valid CompraRequestDTO dadosAtualizados) {
        ...
        public ResponseEntity<EventoResponseDTO> adicionarParticipante(@PathVariable String eventoId,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Remoção aceita, retorna o novo estado da entidade"),
                        @ApiResponse(responseCode = "404", description = "Evento ou participante não encontrados pelo id", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
        ...
        public ResponseEntity<EventoResponseDTO> removerParticipante(@PathVariable String eventoId,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Atualizacao aceita, retorna o novo estado da entidade"),
                        @ApiResponse(responseCode = "404", description = "Evento/participante não encontrados pelo id", content = @Content(schema = @Schema(type = "object", example = "{\n"
                                        +
                                        "  \"erro\": \"Evento/participante não encontrado com id: xxxxxxxx\",\n" +
                                        "}"))),
                        @ApiResponse(responseCode = "409", description = "Conflito de concorrência. O evento foi modificado por outra pessoa.", content = @Content(schema = @Schema(type = "object", example = "{\n"
        ...
        public ResponseEntity<EventoResponseDTO> atualizarParticipante(@PathVariable String eventoId,
                        @PathVariable String participanteId,
                        @RequestBody @Valid ParticipanteRequestDTO dadosAtualizados) {
                Evento eventoAtualizado = eventoService.atualizarParticipante(eventoId, participanteId,
                                dadosAtualizados);
                EventoResponseDTO response = mapper.toResponse(eventoAtualizado);
